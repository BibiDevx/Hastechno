...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2025 a las 23:49:20
...
--
ALTER TABLE `carrito`
  ADD CONSTRAINT `fkcarrito_cliente` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fkcarrito_producto` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE CASCADE ON UPDATE CASCADE;
